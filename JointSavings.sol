...
contract JointSavings {
    ...
    */
    ...
    function deposit() public payable {
        // Set `contractBalance` equal to the balance of the contract by using `address(this).balance` to reflect the new balance of the contract.
        contractBalance = address(this).balance;
    }        
        function deposit(address payable) public {
